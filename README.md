...
如果您是出於善心貢獻小幅更新，請瀏覽並按一下文章中的「**編輯**」連結，可前往文章的 GitHub 來源。然後，只需使用 GitHub UI 進行更新。請參閱一般「[Adobe Docs 貢獻者指南](https://experienceleague.adobe.com/docs/contributor/contributor-guide/introduction.html?lang=zh-Hant)」的更多資訊。
...
如果您是 Adobe Experience Cloud 解決方案的技術作家、方案經理或產品團隊的開發人員，您的工作是貢獻或撰寫技術文章，因此您應該使用私人存放庫：`https://git.corp.adobe.com/AdobeDocs`.
