...
+ 管理和設定 {#administration-and-setup}
   ...
   + 版面配置範本 {#layout-templates}
      ...
      + [使用版面範本自訂[!UICONTROL 主選單]](administration-and-setup/layout-templates/customize-the-main-menu-with-layout-templates.md)
      + [透過版面範本新增和管理釘選功能](administration-and-setup/layout-templates/add-and-manage-pins-in-layout-template.md)
      + [使用版面範本自訂首頁](administration-and-setup/layout-templates/customize-workfront-home-with-layout-templates.md)
      + [指派和管理版面範本的存取權](administration-and-setup/layout-templates/assign-and-manage-access-to-layout-templates.md)
      + [使用版面範本自訂物件區域](administration-and-setup/layout-templates/customize-object-areas-with-a-layout-template.md)
      + [使用版面範本自訂專案詳細資料](administration-and-setup/layout-templates/customize-project-details-with-layout-templates.md)
      + [使用版面範本自訂專案標題](administration-and-setup/layout-templates/customize-project-headers-with-layout-templates.md)
      + [使用版面範本自訂報告清單](administration-and-setup/layout-templates/customize-reporting-lists-with-layout-templates.md)
...
+ 管理工作 {#manage-work}
   ...
   + 請求佇列 {#request-queues}
      ...
      + [建立系統管理員回饋要求佇列](manage-work/request-queues/create-a-system-admin-feedback-request-queue.md)
...
+ 報告 {#reporting}
   ...
   + 增強型分析 {#enhanced-analytics}
      ...
      + [新增[!UICONTROL 分析]到版面範本](reporting/enhanced-analytics/3-adding-analytics-to-layout-templates.md)
      ...
      + [瞭解動作：游標懸停點選與拖曳並點選](reporting/enhanced-analytics/9-actions-hover-click-and-drag-and-click-in.md)
...
+ Workfront 目標 {#workfront-goals}
   ...
   + 建立您的目標 {#create-goals}
      ...
      + [為 [!UICONTROL Workfront Goals] 使用者建立版面範本](workfront-goals/create-your-goals/create-a-layout-template-with-workfront-goals.md)
...
+ Workfront DAM {#workfront-dam-program}
   ...
   + Workfront DAM 使用者：貢獻者 {#workfront-dam-contributor}
      ...
      + [以貢獻者身分瞭解中繼資料和關鍵字最佳實務](workfront-dam/workfront-dam-user-contributor/metadata-and-keyword-best-practices.md)
