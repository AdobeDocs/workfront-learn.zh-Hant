...
+ 管理和設定 {#administration-and-setup}
   ...
   + 版面配置範本 {#layout-templates}
      ...
      + [使用版本配置範本自訂專案詳細資料](administration-and-setup/layout-templates/customize-project-details-with-layout-templates.md)
   ...
   + 核准流程與里程碑路徑 {#approval-processes-and-milestone-paths}
      + [了解特定群組的核准流程](administration-and-setup/approval-processes-and-milestone-paths/group-specific-approval-processes.md)
   ...
   + 專案類務 {#project-finances}
      + [了解績效量度](manage-work/project-finances/understand-performance-metrics.md)
      ...
      + [了解財務資訊存取](manage-work/project-finances/understand-financial-access.md)
...
+ 自訂資料 {#custom-data}
   ...
   + 計算運算式 {#calculated-expressions}
      ...
      + [了解日期和時間以及數學運算式](custom-data/calculated-expressions/date-and-time-and-mathematical-expressions.md)
...
+ 管理工作 {#manage-work}
   + 專案 {#projects}
      + [了解建立專案的基本操作](manage-work/projects/understand-basic-project-creation.md)
      + [了解建立專案的四種方法](manage-work/projects/understand-other-ways-to-create-projects.md)
      ...
      + [了解專案團隊](manage-work/projects/understand-the-project-team.md)
      + [了解專案溝通](manage-work/projects/understand-project-communication.md)
      ...
      + [了解[!UICONTROL 甘特圖]視圖](manage-work/projects/understand-the-gantt-view.md)
      + [了解[!UICONTROL 展示板]視圖](manage-work/projects/understand-the-board-view.md)
   ...
   + 任務 {#tasks}
      ...
      + [了解任務期間](manage-work/tasks/understand-task-durations.md)
      + [了解如何排定任務順序](manage-work/tasks/learn-to-sequence-tasks.md)
      + [了解規劃時數](manage-work/tasks/understand-planned-hours.md)
      + [了解[!UICONTROL 工作投入]](manage-work/tasks/understand-work-effort.md)
   ...
   + 請求佇列 {#request-queues}
      + [了解請求佇列](manage-work/request-queues/understand-request-queues.md)
   ...
   + 專案組合 {#portfolios}
      ...
      + [了解[!UICONTROL 業務案例]](portfolios-and-programs/introduction-to-the-business-case.md)
   ...
   + 建立和管理專案範本 {#create-and-manage-project-templates}
      + [建立專案範本並了解藍圖](manage-work/create-and-manage-project-templates/create-a-project-template.md)
   ...
   + 專案時間表 {#project-timelines}
      + [了解專案時間表](manage-work/project-timelines/understand-project-timelines.md)
   ...
   + 適用於使用者的專案財務資訊 {#project-finances-users}
      ...
      + [了解多種計費費率](manage-work/project-finances/multiple-billing-rates.md)

   + 中間專案 {#intermediate-projects}
      + [了解和管理期限類型和任務限制](manage-work/intermediate-projects/understand-and-manage-duration-types-and-task-constraints.md)
      + [了解跨專案前置任務](manage-work/intermediate-projects/understand-cross-project-predecessors.md)
      + [進階前置任務](manage-work/intermediate-projects/advanced-predecessors.md)


+ 報告 {#reporting}
   + 基本報告 {#basic-reporting}
      + [了解報告元素](reporting/basic-reporting/reporting-elements.md)
      + [了解報告元件](reporting/basic-reporting/reporting-components.md)
      ...
      + [了解報告設定](reporting/basic-reporting/report-settings.md)
   ...
   + 中間報告 {#intermediate-reporting}
      ...
      + [了解內建的問題篩選器](reporting/intermediate-reporting/open-built-in-issue-filters.md)
      + [了解篩選器的基本文字模式](reporting/intermediate-reporting/basic-text-mode-for-filters.md)
      + [了解視圖的基本文字模式](reporting/intermediate-reporting/basic-text-mode-for-views.md)
   ...
   + 行事曆報告 {#calendar-reports}
      + [了解行事曆報告介面](reporting/basic-reporting/tour-of-the-interface.md)
      + [建立自訂行事曆報告](reporting/basic-reporting/creating-custom-calendars.md)
      + [了解其他行事曆報告選項](reporting/basic-reporting/additional-calendar-options.md)
   ...
   + 增強型分析 {#enhanced-analytics}
      ...
      + [了解規劃時數和期間視圖](reporting/enhanced-analytics/8-planned-hours-and-duration-views.md)
      + [了解動作：游標懸停、點選並拖曳以及點選進入](reporting/enhanced-analytics/9-actions-hover-click-and-drag-and-click-in.md)
      + [了解 KPI](reporting/enhanced-analytics/10-kpis-overview.md)
      + [了解如何導覽和檢閱專案](reporting/enhanced-analytics/11-navigating-and-reviewing-projects.md)
      + [使用時間範圍和其他圖表深入了解](reporting/enhanced-analytics/12-digging-deeper-using-timeframes-and-additional-charts.md)
      + [了解如何導覽和檢閱專案活動](reporting/enhanced-analytics/13-navigating-and-reviewing-project-activity.md)
      + [深入了解導覽](reporting/enhanced-analytics/14-navigation-and-digging-deeper.md)
      + [了解存取和檢閱燃盡圖](reporting/enhanced-analytics/15-accessing-and-reviewing-the-burndown.md)
      ...
      + [了解「依團隊檢視活動」圖表](reporting/enhanced-analytics/18-activity-by-team-chart.md)
      + [了解資源產能圖表](reporting/enhanced-analytics/19-resource-capacity-chart.md)
      + [了解團隊產能](reporting/enhanced-analytics/20-team-capacity-overview.md)
      + [了解 KPI 比較的使用案例](reporting/enhanced-analytics/21-kpi-comparisons.md)
      + [了解一般使用者的使用案例](reporting/enhanced-analytics/22-end-user-use.md)
      + [了解諮詢指南](reporting/enhanced-analytics/23-consulting-guidance.md)
...
+ Workfront 目標 {#workfront-goals}
   + 制定組織願景 {#establish-a-vision-and-strategy}
      + [了解 Workfront Goals 的願景](workfront-goals/establish-a-vision-for-your-org/understand-the-vision-behind-workfront-goals.md)
      + [了解 Workfront Goals 如何運作](workfront-goals/establish-a-vision-for-your-org/understand-how-workfront-goals-works.md)
      + [了解 Workfront Goals 如何配合您的工作週期](workfront-goals/establish-a-vision-for-your-org/where-does-workfront-goals-fit-in-with-my-work-cycle.md)
...
+ 整合 {#integrations}
   ...
   + Slack {#slack}
      + [了解適用於 [!UICONTROL Slack] 的 Workfront](integrations/slack/introduction-to-workfront-for-slack.md)
...
+ Fusion {#fusion}
   ...
   + 執行歷史記錄與排程 {#execution-history-and-scheduling}
      ...
      + [了解情境排程](fusion/5-execution-history-and-scheduling/understand-scenario-scheduling.md)
   ...
   + 超越基本模組 {#beyond-basic-modules}
      ...
      + [了解 Webhook 的世界](fusion/6-beyond-basic-modules/understand-the-webhook-world.md)
   ...
   + 資料結構和資料儲存區 {#data-structures-and-data-stores}
      ...
      + [了解資料儲存區](fusion/7-data-structures-and-data-stores/understand-data-stores.md)
   ...
   + 最後的各種小型功能{#final-functional-bits-and-bobs}
      ...
      + [了解陣列、集合和元素](fusion/8-final-functional-bits-and-bobs/understand-arrays-collections-and-elements.md)
      + [陣列操作示範](fusion/8-final-functional-bits-and-bobs/arrays-walkthrough.md)
      + [了解情境中的 JSON](fusion/8-final-functional-bits-and-bobs/understand-json-in-scenarios.md)
   ...
   + 疑難排解與錯誤處理 {#troubleshooting-and-error-handling}
      ...
      + [了解錯誤處理指示](fusion/9-troubleshooting-and-error-handling/understand-error-handling-directives.md)
      + [錯誤處理操作示範](fusion/9-troubleshooting-and-error-handling/error-handling-walkthrough.md)
      + [了解未完成的執行作業](fusion/9-troubleshooting-and-error-handling/understand-incomplete-executions.md)
   ...
   + Workfront Fusion 管理 {#workfront-fusion-administration}
      + [了解組織、團隊和使用者](fusion/10-workfront-fusion-administration/understand-organizations-teams-and-users.md)
...
+ Workfront Proof {#workfront-proof}
   + [了解校訂的好處](workfront-proof/benefits-of-proofing-in-workfront.md)
   + [了解文件和校訂之間的差異](workfront-proof/document-vs-proof.md)
   ...
   + 管理和設定 {#administration-and-setup-for-proof}
      ...
      + [了解電子郵件警報和校訂通知](workfront-proof/administration-and-setup/email-alert-vs-proof-notification.md)
   ...
   + 校訂工作流程 {#proof-workflows}
      + [了解作為專案時間表一部分的校訂工作流程](workfront-proof/proof-workflows/understand-and-create-proof-workflows.md)
   ...
   + 檢閱與核准工作 {#review-and-approve-work-for-proof}
      ...
      + [了解校訂詳細資料](workfront-proof/review-and-approve-work/proof-details-overview.md)
...
+ Workfront DAM {#workfront-dam-program}
   ...
   + Workfront DAM 使用者：貢獻者 {#workfront-dam-contributor}
      + [以貢獻者身分了解 [!UICONTROL Workfront DAM]](workfront-dam/workfront-dam-user-contributor/contributor-getting-started.md)
      + [以貢獻者身分了解資產管理](workfront-dam/workfront-dam-user-contributor/contributor-asset-management.md)
      + [以貢獻者身分了解如何尋找資產](workfront-dam/workfront-dam-user-contributor/contributor-find-assets.md)
      + [以貢獻者身分了解 Lightbox](workfront-dam/workfront-dam-user-contributor/contributor-lightboxes.md)
   ...
   + Brand Connect 使用者 {#brand-connect}
      + [以使用者身分了解 [!UICONTROL Brand Connect]](workfront-dam/brand-connect-user/brand-connect-introduction.md)
      + [以使用者身分了解導覽與搜尋](workfront-dam/brand-connect-user/brand-connect-getting-started.md)
      + [了解 [!UICONTROL Brand Connect] 通知](workfront-dam/brand-connect-user/brand-connect-notifications.md)
      + [以使用者身分了解下載與共用](workfront-dam/brand-connect-user/brand-connect-downloading-and-sharing.md)
      + [以使用者身分了解 Lightbox](workfront-dam/brand-connect-user/brand-connect-lightboxes.md)
...
+ 最佳實務 {#best-practices}
   ...
   + [時程表和記錄時間](best-practices/timesheets-logging-time-bp.md)
