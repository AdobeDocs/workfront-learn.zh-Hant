...
影片說明如何在Workfront中建立和自訂檢視，以顯示清單中專案的特定資訊，例如專案、任務、問題和檔案。 檢視&#x200B;可讓使用者檢視詳細資訊，例如名稱、說明、狀態，以及與專案相關的其他欄位。 &#x200B;
...
* **內嵌編輯**：清單檢視中的某些欄位可以直接更新，而不需要開啟個別專案，因此變更的速度更快。 &#x200B;
* **從頭開始建立檢視**：使用者可以透過新增預算、實際成本和進度狀態等相關欄，來設計檢視以滿足特定需求，例如追蹤專案狀況。 &#x200B;
...
將游標懸停在「[!UICONTROL 狀態圖示]」欄的每個圖示上來看看他們代表的狀態。 如果變灰，表示任務沒有附註、檔案、核准流程等。如果圖示以顏色顯示，則至少有一個專案與任務相關聯。 您可以按一下備註或文件圖示前往該項目。
