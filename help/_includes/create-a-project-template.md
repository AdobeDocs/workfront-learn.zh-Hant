...
![主選單中的藍圖](/help/manage-work/create-and-manage-project-templates/assets/pt-blueprints-01.png)
...
![藍圖清單](/help/manage-work/create-and-manage-project-templates/assets/pt-blueprints-02.png)

「[!UICONTROL 詳細資訊]」畫面說明有關藍圖的更多資訊，包括安裝歷史記錄 (若已安裝藍圖)。

![關於使用藍圖的詳細資訊](/help/manage-work/create-and-manage-project-templates/assets/pt-blueprints-03.png)

如果藍圖已安裝，您可以按一下「**[!UICONTROL 查看詳細資訊]**」取得所建立範本以及為支援該範本而建立的任何其他物件之連結。

![關於安裝藍圖的詳細資訊](/help/manage-work/create-and-manage-project-templates/assets/pt-blueprints-04.png)
