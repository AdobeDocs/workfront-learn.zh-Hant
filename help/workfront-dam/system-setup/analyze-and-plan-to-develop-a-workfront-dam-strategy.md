...
* **後設資料結構** — 結構是一組後設資料欄位，可供 [!UICONTROL Workfront DAM] 中的資產使用。 這些欄位可能包括版權、建立者和位置。 如果您使用第三方應用程式來新增中繼資料，請考慮這些欄位要如何對應到 [!UICONTROL Workfront DAM]。
