...
>[!VIDEO](https://video.tv.adobe.com/v/3497037/?captions=chi_hant&quality=12&learn=on&enablevpops=1)
...
建立一個新情境，把行銷專案組合中各項專案的任務之所有記錄時數加總。 然後傳送一封電子郵件，顯示「您的{Project Name}專案團隊已記錄總{planned hours}個計畫時數中的{summed hours}，使您處於計畫的{percentage}」。
