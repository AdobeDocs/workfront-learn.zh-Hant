...
若要完成Workfront Fusion訓練教學課程中的練習，您需要一個Workfront啟用環境，在本次訓練中也稱為「**Workfront試用版**」。 若您已經參加過產品試用，我們在此一培訓中推薦新的試用方式。

填寫[此表單](https://survey.adobe.com/jfe/form/SV_71xcV8UByyVwgBg)要求提供產品試用。當您填寫表單時，系統會要求您提供&#x200B;**Adobe認證設定檔電子郵件**。 如果您還沒有設定檔，請前往[Adobe認證網站](https://certification.adobe.com/#)並建立使用者設定檔。
