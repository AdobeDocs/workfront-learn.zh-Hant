...
* **專案資訊：**&#x200B;一般詳細資料，例如專案贊助者和計畫收益，可估計完成專案可能帶來的財務收益。 &#x200B;
* **費用：**&#x200B;影響預算成本與淨值的非勞力成本，例如差旅或攤位租金。 &#x200B;
* **資源預算：**&#x200B;從資源規劃工具提取的人工預估，需要在Workfront中設定資源集區。 &#x200B;
* **風險：**&#x200B;識別風險、估計其成本與可能性，並計算其對淨值的影響。 &#x200B;
* **計分卡：**&#x200B;使用系統管理員所設定的預先定義問題和值，評估專案與投資組合目標一致性的工具。 &#x200B;
* **自訂Forms：**&#x200B;針對業務案例量身打造的選用表單。 &#x200B;
