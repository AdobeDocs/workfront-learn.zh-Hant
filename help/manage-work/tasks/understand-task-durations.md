...
* **任務工期的定義：**&#x200B;任務工期是任務的計劃開始日期與計畫完成日期之間的差異，代表完成工作的時間範圍。 &#x200B;
* **對專案時間表的影響：**&#x200B;任務持續時間會直接影響整體專案長度和計畫完成日期，因此對於精確的專案規劃至關重要。 &#x200B;
* **使用前置任務：**&#x200B;計畫的開始和完成日期是使用任務持續時間和前置任務計算，以確保動態和靈活的時間表。 &#x200B;
* **避免手動限制：**&#x200B;手動設定開始日期或完成日期會建立任務限制，以防止持續時間或前置任務變更時自動調整。 &#x200B;
* **資源管理：**&#x200B;持續時間對於Workfront的資源管理和排程工具至關重要，可啟用準確的資源估計和團隊可用性計畫。 &#x200B;
