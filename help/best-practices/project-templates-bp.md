...
* 當您調整範本上的「排程起始日期」選項時，請審閱並更新任務限制。
...
專案範本讓專案經理（和其他建立專案的人）不必再猜測專案應包含哪些任務，以及如何建構時間表等。範本是加速專案建立的最有效方式。
...
除了期間和規劃時數等任務設定以外，在共用範本之前應該審閱的事項包括：
