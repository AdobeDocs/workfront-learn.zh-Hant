...
為外部供應商建立公司，一方面允許供應商進入 Workfront 來審閱為他們打造的內容或產品之進度，另一方面則限制他們在系統內的存取權。
...
在Workfront中共用專案、報表等專案時，使用較大的組織單位（例如群組和團隊）即表示您可以快速輕鬆地與一組選定的人員同時共用物件。 將個別使用者的名稱新增到共用視窗可能極為麻煩又耗時。
