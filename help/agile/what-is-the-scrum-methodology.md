...
Scrum方法包含彈性模型，但與其他方法不同，因為該方法為團隊成員定義了角色（例如產品所有者、浮渣主機等），並定義了用於定義和完成工作的做法。
...
待辦項目整理完成並確認優先順序後，便開始計劃疊代。 （許多組織會交替使用「衝刺」和「反複專案」一詞。） 團隊會根據認為已準備就緒的劇本來決定要完成哪些劇本。 團隊進行指派並決定疊代的期間。
