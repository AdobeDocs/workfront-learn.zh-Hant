---
title: 使用簽入來追蹤和更新目標
description: 瞭解如何在[!DNL Workfront Goals]中追蹤、更新及計算目標的進度。
activity: use
...
在您啟動目標並張貼關於活動或結果的更新之後，[!DNL Workfront Goals] 便開始利用實際的完成百分比、預期的完成百分比或是進度狀態來計算目標進度。 [!UICONTROL 簽入]是定期審閱您的目標並評估您是否進展順利、進度落後或需要調整的好方法。 簽入是指您在某個時間點回報目標的進度。
