...
Dev-Jedi Council 敏捷團隊負責人 Joan Harris 使用 Scrum 展示板和燃盡圖來衡量整個衝刺的進度。 它讓團隊透過美觀的視覺化圖像瞭解現況。 此外，這些資訊也會納入每季審閱的執行報告中。 不過，大部分團隊在 [!DNL Jira] 進行更新，而非 [!DNL Workfront]。
...
當指派至「審閱硬體要求」故事的團隊成員對 [!DNL Jira] 中的狀態進行更新，將「新增」變為「進行中」時，該更新也會自動變更 [!DNL Workfront] 中故事的狀態。
