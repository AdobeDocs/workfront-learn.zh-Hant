...
| 最佳實務 | 原因說明 |
|---|---|
| 調整校訂後端設定，用 12 小時制向使用者顯示截止期限。 | 若使用者想要以AM/PM格式檢視校訂截止日期/時間，請在校訂設定中選取F j、Y、gi:a選項。 對於使用 12 小時制的地區，這樣可以讓截止期限更明確。 <br> <br>備註：這項設定可前往 Workfront 主選單 >「校訂」>「帳戶設定」>「使用者」，並編輯每位使用者「日期格式」欄位。 |
